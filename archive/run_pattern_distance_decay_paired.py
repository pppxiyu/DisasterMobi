...
Outputs (under outputs/archive/distance_decay_paired/)
------------------------------------------------------
...
# when run as `python archive/run_pattern_distance_decay_paired.py` from the repo root.
...
from utils.pattern_analysis.graph_io import load_graphs, build_distance_array
...
OUTPUT_DD = os.path.join(OUTPUT_DIR, 'archive', 'distance_decay_paired')
