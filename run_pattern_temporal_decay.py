...
from utils_pattern_analysis.graph_io import load_graphs, calculate_total_flows
from utils_pattern_analysis.temporal import run_temporal_decay_analysis_pipeline
...
OUTPUT_PLOTS = os.path.join(OUTPUT_DIR, 'temporal_decay')
...
def main():
    ...
    decay_model   = results['gamma_model']
    ...
    out_path = os.path.join(OUTPUT_DIR, 'temporal_decay_results_br.pkl')
