# =============================================================================
# 2026-08-03 DISABLED - do not run.
# The downstream objective here (cross-city cum_loss LOO-MAE) is RETIRED:
# NMF hyperparameters are now tuned by RECONSTRUCTION QUALITY + the
# component-count health constraint (tune_nmf_recon.py), which was itself
# retired on 2026-08-04: reconstruction error falls monotonically in k, so that
# objective had no interior optimum either.  k is now read off the rank
# cross-validation (run_pattern_nmf STEP 1) and set by hand in the registry.
# Rationale: the city-MAE objective overfit its tiny validation set twice
# (v1-v3 two-city probe, +0.92; v7 city-MAE, 0.897->1.46 on production) and
# was reverted both times; reconstruction quality is measured on the unit
# itself and cannot overfit a downstream split.
# The whole file is commented out (kept for history / provenance).
# =============================================================================
# """
